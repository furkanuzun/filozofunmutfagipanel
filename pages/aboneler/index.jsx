...
const Page = () => {
  ...
  const getForms = () => {
    axios
      .get("http://localhost:3000/api/users/get-subs")
      .then((res) => {
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>Aktif Paket</TableCell>
                ...
                {users.map((user) => {
                  ...
                  return (
                    <TableRow hover key={user._id}>
                      ...
                      <TableCell>
                        <Typography variant="subtitle2">{`${user.currentSubscription.title}`}</Typography>
                      </TableCell>
                      <TableCell>
                        <Typography variant="subtitle2">{`${user.currentSubscription.localizedPrice}`}</Typography>
                      </TableCell>
                    </TableRow>
                  );
                })}
